...
本地脚本已负责 15m 状态过滤（TREND/RANGE/NO_TRADE）、15m 入场触发、3m 趋势加速/回踩确认、MACD/KDJ 方向判断、开平仓执行；你只能微调资金流因子权重与 confidence。
tech/capture context 仅用于判断是否该降低或提高 confidence，以及微调权重，不能替代本地规则，也不能覆盖 15m/3m 的本地决策链。
...
class DeepSeekAIService:
    ...
    def _build_request_payload(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        common_payload = {
            ...
            "tech": {
                "mc": str(tech_context.get("macd_cross_exec", tech_context.get("macd_cross_15m", tech_context.get("macd_cross_5m", "NONE")))),
                "mz": str(tech_context.get("macd_zone_exec", tech_context.get("macd_zone_15m", tech_context.get("macd_zone_5m", "NEAR_ZERO")))),
                "mh": bool(tech_context.get("macd_hist_expand_exec", tech_context.get("macd_hist_expand_15m", tech_context.get("macd_hist_expand_5m", False)))),
                "kc": str(tech_context.get("kdj_cross_exec", tech_context.get("kdj_cross_15m", tech_context.get("kdj_cross_5m", "NONE")))),
                "kz": str(tech_context.get("kdj_zone_exec", tech_context.get("kdj_zone_15m", tech_context.get("kdj_zone_5m", "MID")))),
            },
            "capture": {
    ...
    def _build_context(
        ...
        if ma10_bias_num > 0:
            ...
            ma10_bias_1h = "FLAT"
        macd_cross_exec = str(
            tf_15m.get("macd_cross", market_flow_context.get("macd_cross_exec", market_flow_context.get("macd_15m_cross", market_flow_context.get("macd_5m_cross", "NONE"))))
        ).upper()
        macd_zone_exec = str(
            tf_15m.get("macd_zone", market_flow_context.get("macd_zone_exec", market_flow_context.get("macd_15m_zone", market_flow_context.get("macd_5m_zone", "NEAR_ZERO"))))
        ).upper()
        macd_hist_expand_exec = bool(
            tf_15m.get(
                "macd_hist_expand",
                market_flow_context.get(
                    "macd_hist_expand_exec",
                    market_flow_context.get(
                        "macd_15m_hist_expand",
                        market_flow_context.get("macd_5m_hist_expand", False),
                    ),
                ),
            )
        )
        kdj_cross_exec = str(
            tf_15m.get("kdj_cross", market_flow_context.get("kdj_cross_exec", market_flow_context.get("kdj_cross_15m", market_flow_context.get("kdj_cross", "NONE"))))
        ).upper()
        kdj_zone_exec = str(
            tf_15m.get("kdj_zone", market_flow_context.get("kdj_zone_exec", market_flow_context.get("kdj_zone_15m", market_flow_context.get("kdj_zone", "MID"))))
        ).upper()
        ...
        return {
            ...
            "tech_context": {
                ...
                "macd_cross_exec": macd_cross_exec,
                "macd_zone_exec": macd_zone_exec,
                "macd_hist_expand_exec": bool(macd_hist_expand_exec),
                "kdj_cross_exec": kdj_cross_exec,
                "kdj_zone_exec": kdj_zone_exec,
                "macd_cross_15m": macd_cross_exec,
                "macd_zone_15m": macd_zone_exec,
                "macd_hist_expand_15m": bool(macd_hist_expand_exec),
                "kdj_cross_15m": kdj_cross_exec,
                "kdj_zone_15m": kdj_zone_exec,
                "macd_cross_5m": macd_cross_exec,
                "macd_zone_5m": macd_zone_exec,
                "macd_hist_expand_5m": bool(macd_hist_expand_exec),
                "kdj_cross_5m": kdj_cross_exec,
                "kdj_zone_5m": kdj_zone_exec,
            },
            "ret_3m": ret_3m,
